...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get all reviews for a specific gig' }),
    __param(0, (0, common_1.Param)('gigId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ReviewsController.prototype, "getGigReviews", null);
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new review for a completed order' }),
